...
public class MainActivity extends AppCompatActivity {
    ...
    public void submitOrder(View view) {
       //Find the user's name
        ...
        //Figured out if the user wants whipped cream topping
        ...
        //Figured out if the user wants chocolate topping
        ...
        intent.setData(Uri.parse("malito:")); //only email app should handle this
    ...
    private int calculatePrice(boolean addWhippedCream, boolean addChocolate) {
        ...
        //Calculate the order price by multiplying quantity
